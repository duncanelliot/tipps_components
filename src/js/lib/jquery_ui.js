...
(function (factory) {
  ...
  var widgetsMouse = $.widget("ui.mouse", {
    ...
    _mouseDistanceMet: function (event) {
      return (
        Math.max(Math.abs(this._mouseDownEvent.pageX - event.pageX), Math.abs(this._mouseDownEvent.pageY - event.pageY)) >= this.options.distance
      );
    },
  ...
  $.widget("ui.draggable", $.ui.mouse, {
    ...
    _mouseStop: function (event) {
      ...
      if (
        ...
        (typeof this.options.revert === "function" && this.options.revert.call(this.element, dropped))
      ) {
...
*/
  ...
  var widgetsSortable = $.widget("ui.sortable", $.ui.mouse, {
    ...
    _convertPositionTo: function (d, pos) {
      ...
      var mod = d === "absolute" ? 1 : -1,
        scroll =
          this.cssPosition === "absolute" && !(this.scrollParent[0] !== this.document[0] && $.contains(this.scrollParent[0], this.offsetParent[0]))
            ? this.offsetParent
            : this.scrollParent,
